...
export const InventoryCard: React.FC<InventoryCardProps> = ({ item, onSelect }) => {
  ...
  return (
    <div
      ...
      className="group bg-slate-900 rounded-2xl border border-slate-800 hover:border-amber-500/50 shadow-md hover:shadow-2xl hover:shadow-amber-500/5 transition-all cursor-pointer flex flex-col overflow-hidden text-white"
    >
      {/* Photo Container */}
      <div className="relative aspect-[4/3] bg-slate-950 overflow-hidden">
        ...
        {/* Featured Badge */}
        {item.isFeatured && (
          <div className="absolute top-2.5 left-2.5 bg-amber-500 text-slate-950 text-[10px] font-black px-2 py-0.5 rounded-md shadow flex items-center gap-1">
        ...
        {/* Price Tag Overlay */}
        <div className="absolute bottom-2.5 left-2.5 bg-slate-950/90 backdrop-blur-md px-3 py-1 rounded-xl border border-slate-800 text-amber-400 font-black text-sm md:text-base shadow-lg">
